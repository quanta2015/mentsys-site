      ...
      <Form form={form} className={s.frm}>
        ...
        <div className={s.frmr}>
          ...
          <div className={s.attr}>
            ...
            <Form.Item
              name="skill"
              initialValue={store.user?.skill}
              rules={[{ required: true, message: "请选择个人特长" }]}
            >
              <Select
                mode="multiple"
                allowClear
          ...
          <div className={s.attr}>
            ...
            <Form.Item
              name="cert"
              initialValue={store.user?.cert}
              rules={[{ required: true, message: "请选择获得证书" }]}
            >
              <Select
                mode="multiple"
                allowClear
          ...
          <div className={s.attr}>
            ...
            <section>
              ...
              <Form.Item
                name="sche0"
                initialValue={store.user?.schedule[0]}
                rules={[{ required: true, message: "请选择学业规划" }]}
              >
                <Select
                  mode="multiple"
                  allowClear
            ...
            <section>
              ...
              <Form.Item
                name="sche1"
                initialValue={store.user?.schedule[1]}
                rules={[{ required: true, message: "请选择学业规划" }]}
              >
                <Select
                  mode="multiple"
            ...
            <section>
              ...
              <Form.Item
                name="sche2"
                initialValue={store.user?.schedule[2]}
                rules={[{ required: true, message: "请选择学业规划" }]}
              >
                <Select
                  mode="multiple"
            ...
            <section>
              ...
              <Form.Item
                name="sche3"
                initialValue={store.user?.schedule[3]}
                rules={[{ required: true, message: "请选择学业规划" }]}
              >
                <Select
                  mode="multiple"
          ...
          <div className={s.fun}>
            <Button type="primary" size="large" onClick={saveStudent}>
              保 存
            </Button>
          </div>
        </div>
